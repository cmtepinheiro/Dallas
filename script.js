...
function runBootSequence(onComplete) {
    ...
    // unless the video is also autoplaying. We let it autoplay muted and
    // invisible right away purely to force real buffering, then pause it
    // almost instantly so it holds near frame 0 — ready to resume cleanly
    // from the start the moment the boot log finishes.
    ...
    setTimeout(() => {
        startVideo.classList.add("is-visible");
