...
// =====================================================
// MANIFESTO AUDIO — plays once in full when the image
// scrolls into view, even if the user scrolls away after.
// =====================================================
(function initManifestoAudio() {
    const img = document.querySelector(".manifesto-visual");
    const audio = document.getElementById("manifestoAudio");
    if (!img || !audio) return;
